...
BEGIN
    ...
    SELECT table_id INTO table3ID FROM `tables` WHERE table_name = "purchases";
...
BEGIN
    ...
    DECLARE table10ID TINYINT;
    DECLARE table11ID TINYINT;
	SELECT manager_id INTO tempID FROM `manager` WHERE manager_id = NEW.manager_id;
	SELECT table_id INTO tableID FROM `tables` WHERE table_name = "trips";
    SELECT table_id INTO table2ID FROM `tables` WHERE table_name = "vehicle";
    SELECT table_id INTO table3ID FROM `tables` WHERE table_name = "packages";
    SELECT table_id INTO table11ID FROM `tables` WHERE table_name = "record";
    ...
    SELECT table_id INTO table10ID FROM `tables` WHERE table_name = "purchases";
    ...
    INSERT INTO `easyinventoryDB`.`permissions` (`fk_ezi_account`, `permission_level`, `fk_table`) VALUES (tempID, 9, table11ID);
    INSERT INTO `easyinventoryDB`.`permissions` (`fk_ezi_account`, `permission_level`, `fk_table`) VALUES (tempID, 9, table5ID);
    INSERT INTO `easyinventoryDB`.`permissions` (`fk_ezi_account`, `permission_level`, `fk_table`) VALUES (tempID, 1, table10ID);
    INSERT INTO `easyinventoryDB`.`permissions` (`fk_ezi_account`, `permission_level`, `fk_table`) VALUES (tempID, 1, table4ID);
    INSERT INTO `easyinventoryDB`.`permissions` (`fk_ezi_account`, `permission_level`, `fk_table`) VALUES (tempID, 1, table6ID);
    INSERT INTO `easyinventoryDB`.`permissions` (`fk_ezi_account`, `permission_level`, `fk_table`) VALUES (tempID, 1, table7ID);
    INSERT INTO `easyinventoryDB`.`permissions` (`fk_ezi_account`, `permission_level`, `fk_table`) VALUES (tempID, 1, table8ID);
    INSERT INTO `easyinventoryDB`.`permissions` (`fk_ezi_account`, `permission_level`, `fk_table`) VALUES (tempID, 1, table9ID);
END$$
